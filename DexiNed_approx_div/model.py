...
from approx_calls import approx_DenseLayer, approx_DenseBlock, approx_UpConvBlock, approx_SingleConvBlock, approx_DoubleConvBlock
...
class DexiNed(nn.Module):
    ...
    def __init__(self):
        ...
        self.block_1 = approx_DoubleConvBlock(3, 32, 64, stride=2,)
