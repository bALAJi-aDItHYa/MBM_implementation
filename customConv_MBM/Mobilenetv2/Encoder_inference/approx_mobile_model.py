...
from orig_model import mobilenet_v2_custom
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        #Custom mobilenet impl for approx conv2d to be applied
        self.original_model = mobilenet_v2_custom( pretrained=False )
