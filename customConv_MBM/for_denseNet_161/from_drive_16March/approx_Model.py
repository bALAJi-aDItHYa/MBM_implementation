...
#from custom_conv import approxconv2d
...
class Decoder(nn.Module):
    def __init__(self, num_features=2208, decoder_width = 0.5):
        ...
        self.conv2 = approxconv2d(num_features, features, kernel_size=1, stride=1, padding=0) #Here mate
...
class approx_model(nn.Module):
    def __init__(self):
        super(approx_model, self).__init__()
